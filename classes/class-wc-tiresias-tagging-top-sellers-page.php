 ...
 * @since 1.0.0
 */
class WC_Tiresias_Tagging_Top_Sellers_Page
{
	/**
	...
	protected static $post_default_data = array(
		...
		'post_content'   => '<div class="tiresias_element" id="tiresias-page-top-sellers"></div>',
		'post_type'      => 'page',
	 ...
	 * @return WC_Tiresias_Tagging_Top_Sellers_Page
	 */
